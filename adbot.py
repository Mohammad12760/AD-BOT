...
DEFAULT_CONFIG = {
    ...
    "announcement_message": "برای اجاره بات به آیدی @T.IC پیام دهید!"
}
    ...
    def get_message(self, key, **kwargs):
        messages = {
            "fa": {
                ...
                "invalid_command": "❌ دستور نامعلوم! برای دیدن دستورات بات !help استفاده کنید یا به @T.IC پیام بدید.",
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a913115634c6e6ec5d56d1a")
    api_token = os.getenv("API_TOKEN", "0068218e4e163a484a69b2b35431117919785c8c5730f5301c1388a88687c6b6")
